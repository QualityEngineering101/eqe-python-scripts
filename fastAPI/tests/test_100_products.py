...
def test_create_product(test_client:TestClient, payload, expected_status_code, err_msg, err_desc):
...
def test_get_product_by_id(test_client:TestClient, id, expected_status_code, err_msg, err_desc):
...
def test_invalid_product_fetch(test_client: TestClient, id, expected_status_code, err_msg, err_desc):
