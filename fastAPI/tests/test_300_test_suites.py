...
class TestSuites():
    ...
    def setup_class(cls):
        # Load Test Data
        pass
    def test_get_all_test_suites(self,test_client: TestClient):
        """Test retrieving all test suites"""
        response = test_client.get("/test_suites/")
        assert response.status_code == 200
        assert isinstance(response.json(), list)

    def test_create_test_suite(self,test_client: TestClient):
    ...
    def test_update_test_suite(self,test_client: TestClient):
    ...
    def test_delete_test_suite(self,test_client: TestClient):
